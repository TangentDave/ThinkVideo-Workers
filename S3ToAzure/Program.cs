namespace ThinkVideo.S3ToAzure
{
    using System;
    ...
    static class Program
    {
        ...
        private static readonly RegionEndpoint S3BucketRegion = RegionEndpoint.EUWest1;

        // Change it to your S3 bucket name to copy data from.
        private static readonly string S3BucketName = "thinkvideo";

        // Change it to your Azure blob container name to copy data to.
        private static readonly string AzureContainerName = "newvideos";

        #endregion

        // This progra uses two threads working as producer and consumer. This job queue is used to share data between two threads.
        ...
        private static void ListFromS3()
        {
            ...
            while (!listFinish)
            {
                ...
                foreach (var source in listObjectResponse.S3Objects)
                {
                    ...
                    var job = CreateServiceSideTransferJob(source);
